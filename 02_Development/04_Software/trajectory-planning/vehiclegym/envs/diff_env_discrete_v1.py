...
class VehicleTfmEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.state = (self.sensors[1], self.sensors[0], self.sensors[2])
    ...
    def _is_done(self):
        ...
        elif self.obs and ((e_lat, long_dist) in self.obstacles):
            done = True
        else:
            done = False
    ...
    def _reward(self, action):
        ...
        if self.obs and ((e_lat, long_dist) in self.obstacles):
            reward_obs = -1
        else:
            reward_obs = 0
