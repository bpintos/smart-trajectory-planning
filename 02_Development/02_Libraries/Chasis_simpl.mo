block Chasis
  Modelica.Blocks.Interfaces.RealInput delta annotation(
    Placement(visible = true, transformation(extent = {{-100, -20}, {-60, 20}}, rotation = 0), iconTransformation(origin = {-74, 20}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
  ...
  constant Real vel = 2.5;
  parameter Real lf = 0.12;
  parameter Real lr = 0.16;
  Real theta(start = -20*pi/180);
  Real x(start = 0);
  Real y(start = 0);
  Real delta_rad;
  Real beta;
