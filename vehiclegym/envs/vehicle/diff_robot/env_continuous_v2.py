...
State: laser measurements + linear velocity + angular velocity
Safety, legal and task (energy) requirements
...
class VehicleTfmEnv(gym.Env):
    ...
    def _reward(self):
        ...
        # Final reward
        reward = k_safety*reward_safety + k_legal*reward_legal + k_task*reward_task
