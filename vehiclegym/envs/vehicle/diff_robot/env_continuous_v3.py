...
State: laser measurements + linear velocity + angular velocity + angular acceleration
...
class VehicleTfmEnv(gym.Env):
    ...
    def _getState(self):
        ...
        state = list(laser_distances) + [vel_norm_lin] + [vel_norm_ang] + [accel_ang_norm]
